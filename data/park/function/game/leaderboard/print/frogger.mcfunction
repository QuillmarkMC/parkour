...
tellraw @s [{"translate":"text.game.course_name.frogger","bold":true,"underlined":true,"color":"red"},{"translate":"text.lobby.leaderboard","bold":true,"underlined":true,"color":"red"},{"text":" -","bold":true,"underlined":false}]
