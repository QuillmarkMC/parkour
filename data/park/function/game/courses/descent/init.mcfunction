...
data modify storage park:checkpoint_constructor Course set value 1
data modify storage park:checkpoint_constructor Rotation set value 15.0f
...
data modify storage park:checkpoint_constructor Course set value 1
data modify storage park:checkpoint_constructor Rotation set value -135.0f
...
data modify storage park:checkpoint_constructor Course set value 1
data modify storage park:checkpoint_constructor Rotation set value -160.0f
...
data modify storage park:checkpoint_constructor Course set value 1
data modify storage park:checkpoint_constructor Rotation set value 25.0f
