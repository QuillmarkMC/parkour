...
execute if score @s frogger_pb matches 2147483647 run item replace entity @s armor.feet with leather_boots[unbreakable={},enchantments={binding_curse:1},tooltip_display={hidden_components:["unbreakable","enchantments"]}] 1
execute unless score @s frogger_pb matches 2147483647 run item replace entity @s armor.feet with chainmail_boots[unbreakable={},enchantments={binding_curse:1},tooltip_display={hidden_components:["unbreakable","enchantments"]}] 1
