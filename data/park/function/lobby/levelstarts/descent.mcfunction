...
tellraw @s [{"text":""},{"text":"YOUR ","bold":true,"color":"green"},{"text":"DESCENT","bold":true,"color":"#97B0A1"},{"text":" PERSONAL BEST:","bold":true,"color":"green"},{"text":" "},{"storage":"park:ticks_to_time","nbt":"Time.Minutes"},{"text":":"},{"storage":"park:ticks_to_time","nbt":"Time.SecsZero"},{"storage":"park:ticks_to_time","nbt":"Time.Seconds"},{"text":"."},{"storage":"park:ticks_to_time","nbt":"Time.Tenths"}]
