...
spawnpoint @s -1152 72 2107 -90 0
...
tellraw @s [{"text":""},{"translate":"text.game.start.1","bold":true,"color":"green"},{"translate":"text.game.course_name.frogger","bold":true,"color":"red"},{"translate":"text.game.start.2","bold":true,"color":"green"},{"text":" "},{"storage":"park:ticks_to_time","nbt":"Time.Minutes",interpret:true},{"text":":"},{"storage":"park:ticks_to_time","nbt":"Time.SecsZero",interpret:true},{"storage":"park:ticks_to_time","nbt":"Time.Seconds",interpret:true},{"text":"."},{"storage":"park:ticks_to_time","nbt":"Time.Tenths",interpret:true}]
