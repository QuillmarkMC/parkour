...
#Summon entities on reload
execute unless score $EntityLoad var matches 1 if score $EntityLoadTimer var matches 100.. run function park:lobby/summons/init
execute unless score $EntityLoad var matches 1 run scoreboard players add $EntityLoadTimer var 1
execute unless score $EntityLoad var matches 1 if entity @a run function park:lobby/summons/init
