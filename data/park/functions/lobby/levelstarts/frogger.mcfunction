...
tellraw @s [{"text":""},{"text":"YOUR ","bold":true,"underlined":true,"color":"green"},{"text":"FROGGER","bold":true,"underlined":true,"color":"red"},{"text":" PERSONAL BEST:","bold":true,"underlined":true,"color":"green"},{"text":" "},{"storage":"park:ticks_to_time","nbt":"Time.Minutes"},{"text":":"},{"storage":"park:ticks_to_time","nbt":"Time.SecsZero"},{"storage":"park:ticks_to_time","nbt":"Time.Seconds"},{"text":"."},{"storage":"park:ticks_to_time","nbt":"Time.Tenths"}]
