...
execute store result storage park:ticks_to_time Minutes int 1 run scoreboard players get $math ticks_to_time

#Calc secs
scoreboard players operation $math ticks_to_time = $total ticks_to_time
scoreboard players operation $math ticks_to_time %= $1200 ticks_to_time
scoreboard players operation $math ticks_to_time /= $20 ticks_to_time
execute store result storage park:ticks_to_time Seconds int 1 run scoreboard players get $math ticks_to_time

#Calc tenths
scoreboard players operation $math ticks_to_time = $total ticks_to_time
scoreboard players operation $math ticks_to_time %= $20 ticks_to_time
scoreboard players operation $math ticks_to_time /= $2 ticks_to_time
execute store result storage park:ticks_to_time Tenths int 1 run scoreboard players get $math ticks_to_time

#For formatting style
execute store result score $format ticks_to_time run data get storage park:ticks_to_time Seconds 1
