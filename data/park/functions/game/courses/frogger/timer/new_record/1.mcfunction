...
#1st -> 2nd
execute unless score @s player_id = $4 frogger_record_ids unless score @s player_id = $3 frogger_record_ids unless score @s player_id = $2 frogger_record_ids unless score @s player_id = $1 frogger_record_ids run function park:game/courses/frogger/timer/new_record/move_down/1
