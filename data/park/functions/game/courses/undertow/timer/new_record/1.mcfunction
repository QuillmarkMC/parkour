...
#1st -> 2nd
execute unless score @s player_id = $4 undertow_record_ids unless score @s player_id = $3 undertow_record_ids unless score @s player_id = $2 undertow_record_ids unless score @s player_id = $1 undertow_record_ids run function park:game/courses/undertow/timer/new_record/move_down/1
