item replace entity @s hotbar.0 with trident[unbreakable={},enchantments={levels:{"minecraft:riptide":3}}] 1
...
execute if score @s undertow_pb matches 2147483647 run item replace entity @s armor.feet with leather_boots[unbreakable={show_in_tooltip:false},enchantments={levels:{"minecraft:binding_curse":1},show_in_tooltip:false}] 1
execute unless score @s undertow_pb matches 2147483647 run item replace entity @s armor.feet with chainmail_boots[unbreakable={show_in_tooltip:false},enchantments={levels:{"minecraft:binding_curse":1},show_in_tooltip:false}] 1
