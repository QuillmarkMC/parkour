...
execute as @a[scores={gamestate=1,descent_timer_toggle=0,descent_countdown_timer=15}] run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 100 1
...
execute as @a[scores={gamestate=1,descent_timer_toggle=0,descent_countdown_timer=35}] run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 100 1
...
execute as @a[scores={gamestate=1,descent_timer_toggle=0,descent_countdown_timer=55}] run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 100 1
...
execute as @a[scores={gamestate=1,descent_timer_toggle=0,descent_countdown_timer=75}] run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 100 2
