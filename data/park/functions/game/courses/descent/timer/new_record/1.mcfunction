...
#2nd -> 3rd
execute unless score @s player_id = $4 descent_record_ids unless score @s player_id = $3 descent_record_ids unless score @s player_id = $2 descent_record_ids run function park:game/courses/descent/timer/new_record/move_down/2
#1st -> 2nd
execute unless score @s player_id = $4 descent_record_ids unless score @s player_id = $3 descent_record_ids unless score @s player_id = $2 descent_record_ids unless score @s player_id = $1 descent_record_ids run function park:game/courses/descent/timer/new_record/move_down/1
