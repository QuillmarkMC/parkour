#4th -> 5th
execute unless score @s player_id = $1 frozen_hell_record_ids unless score @s player_id = $2 frozen_hell_record_ids unless score @s player_id = $3 frozen_hell_record_ids unless score @s player_id = $4 frozen_hell_record_ids run function park:game/courses/frozen_hell/timer/new_record/move_down/4
#3rd -> 4th
execute unless score @s player_id = $1 frozen_hell_record_ids unless score @s player_id = $2 frozen_hell_record_ids unless score @s player_id = $3 frozen_hell_record_ids run function park:game/courses/frozen_hell/timer/new_record/move_down/3
#2nd -> 3rd
execute unless score @s player_id = $1 frozen_hell_record_ids unless score @s player_id = $2 frozen_hell_record_ids run function park:game/courses/frozen_hell/timer/new_record/move_down/2
#1st -> 2nd
