...
execute if entity @s[team=Invisible] run tellraw @s {"text":"Players are now visible."}
execute if entity @s[team=Invisible] run team join Visible @s
execute if entity @s[team=Visible] unless entity @s[tag=TempTeam] run tellraw @s {"text":"Players are now visible."}
