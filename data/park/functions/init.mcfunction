...
execute positioned -615.50 69.50 22.0 summon minecraft:item_display run data merge entity @s {Tags:["logo"],Rotation:[120F,0F],"item":{id:"minecraft:iron_nugget",Count:1,tag:{CustomModelData:3}},transformation:{scale:[8.5f,8.5f,0.0f]}}
...
execute positioned -682.54 66.00 -20.54 summon minecraft:item_display run data merge entity @s {Tags:["logo"],Rotation:[300F,0F],"item":{id:"minecraft:iron_nugget",Count:1,tag:{CustomModelData:6}},transformation:{scale:[8.5f,8.5f,0.0f]}}