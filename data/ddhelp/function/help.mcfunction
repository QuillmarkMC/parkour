...
tellraw @s ["",{"text":"/function ddhelp:remove {Player:PLAYER_NAME}","underlined":true,"color":"aqua","clickEvent": {"action":"suggest_command","value":"/function ddhelp:remove {Player:PLAYER_NAME}"}},{"text":" (CLICK TEXT)"}]
